...
@section('content')
    <h1>Editar producto de sorgo</h1>
    <p class="text-secondary">Editar un nuevo producto de sorgo</p>
            ...
            <div class="row ">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="carac_gene_uso" name="carac_gene_uso" value="{{$product->carac_gene_uso}}">
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="planta_tipo_tallo" name="carac_plantas_tallo_tipo" value="{{$product->carac_plantas_tallo_tipo}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="planta_panoja">Panoja</label>
                        <input type="text" class="form-control" id="planta_panoja" name="carac_plantas_panoja" value="{{$product->carac_plantas_panoja}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="planta_color_grano">Color de grano</label>
                        <input type="text" class="form-control" id="planta_color_grano" name="carac_plantas_grano_color" value="{{$product->carac_plantas_grano_color}}">
                    </div>
                </div>
                {{--                <div class="col-sm-12 col-md-6">--}}
                {{--                    <div class="form-group">--}}
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="planta_taninos" name="carac_plantas_taninos" value="{{$product->carac_plantas_taninos}}">
                    </div>
                </div>
                {{--                <div class="col-sm-12 col-md-6">--}}
                {{--                    <div class="form-group">--}}
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="enfer_fusarium" name="enfermedad_fusarium" value="{{$product->enfermedad_fusarium}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_hongos_panoja">Hongos de panoja</label>
                        <input type="text" class="form-control" id="enfer_hongos_panoja" name="enfermedad_panoja_hongos" value="{{$product->enfermedad_panoja_hongos}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_virus_mdmv">Virus MDMV</label>
                        <input type="text" class="form-control" id="enfer_virus_mdmv" name="enfermedad_virus_mdmv" value="{{$product->enfermedad_virus_mdmv}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_pulgon_verde">Pulgón verde</label>
                        <input type="text" class="form-control" id="enfer_pulgon_verde" name="enfermedad_pulgon_verde" value="{{$product->enfermedad_pulgon_verde}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_mosquita">Mosquita</label>
                        <input type="text" class="form-control" id="enfer_mosquita" name="enfermedad_mosquita" value="{{$product->enfermedad_mosquita}}">
                    </div>
                </div>

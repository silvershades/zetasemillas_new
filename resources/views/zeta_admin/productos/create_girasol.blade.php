...
@section('content')
    <h1>Nuevo producto de girasol</h1>
    <p class="text-secondary">Crear un nuevo producto de girasol</p>
...
{{--                </div>--}}
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="planta_capitulo" name="planta_capitulo">
                    </div>
                </div>
{{--                <div class="col-sm-12 col-md-6">--}}
{{--                    <div class="form-group">--}}

...
@section('content')
    <h1>Editar producto de girasol</h1>
    <p class="text-secondary">Editar un nuevo producto de girasol</p>
            ...
            <div class="row ">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="carac_gene_mercado" name="carac_gene_mercado" value="{{$product->carac_gene_mercado}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="carac_gene_tecnologia">Tecnología</label>
                        <input type="text" class="form-control" id="carac_gene_tecnologia" name="carac_gene_tecnologia" value="{{$product->carac_gene_tecnologia}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="carac_gene_materia_grasa">Materia grasa</label>
                        <input type="text" class="form-control" id="carac_gene_materia_grasa" name="carac_gene_materia_grasa" value="{{$product->carac_gene_materia_grasa}}">
                    </div>
                </div>
                {{--                <div class="col-sm-12 col-md-6">--}}
                {{--                    <div class="form-group">--}}
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ciclo_floracion" name="ciclo_dias_floracion" value="{{$product->ciclo_dias_floracion}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="densidad_cond_optima" name="densidad_cond_optimas" value="{{$product->densidad_cond_optimas}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="densidad_cond_no_optima">Condiciones no optimas</label>
                        <input type="text" class="form-control" id="densidad_cond_no_optima" name="densidad_cond_no_optimas" value="{{$product->densidad_cond_no_optimas}}">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="planta_color_arquenio" name="carac_plantas_arquenio_color" value="{{$product->carac_plantas_arquenio_color}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="planta_capitulo">Posición de capítulo</label>
                        <input type="text" class="form-control" id="planta_capitulo" name="carac_plantas_posicion_capitulo" value="{{$product->carac_plantas_posicion_capitulo}}">
                    </div>
                </div>
                {{--                <div class="col-sm-12 col-md-6">--}}
                {{--                    <div class="form-group">--}}
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="enfer_downy" name="enfermedad_downy_mildew" value="{{$product->enfermedad_downy_mildew}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_verticilium">Verticilium</label>
                        <input type="text" class="form-control" id="enfer_verticilium" name="enfermedad_verticillium" value="{{$product->enfermedad_verticillium}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_esclerotinia">Esclerotinia</label>
                        <input type="text" class="form-control" id="enfer_esclerotinia" name="enfermedad_esclerotinia" value="{{$product->enfermedad_esclerotinia}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_phomopsis">Phomopsis</label>
                        <input type="text" class="form-control" id="enfer_phomopsis" name="enfermedad_phomopsis" value="{{$product->enfermedad_phomopsis}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        <label for="enfer_vuelco">Vuelco / quebrado</label>
                        <input type="text" class="form-control" id="enfer_vuelco" name="enfermedad_vuelco_quebrado" value="{{$product->enfermedad_vuelco_quebrado}}">
                    </div>
                </div>
                {{--                <div class="col-sm-12 col-md-6">--}}
                {{--                    <div class="form-group">--}}
